...
const ResetPasswordPage = () => {
  ...
  return (
    <>
      <div className={`min-h-screen ${bgMain} ${textMain} selection:bg-brand-primary selection:text-white`}>
        <Header />
        <main className="flex items-center justify-center px-4 py-12 min-h-[80vh]">
          <div className={`w-full max-w-md space-y-8 ${cardBg} p-8 sm:p-12 rounded-[2.5rem] border ${cardBorder} ${cardShadow} relative overflow-hidden animate-fade-in`}>
